...
public class BlockResearchTable extends Block implements ITileEntityProvider {
	...
	public boolean onBlockActivated(World parWorld, BlockPos parBlockPos, IBlockState parIBlockState,
			EntityPlayer parPlayer, EnumHand hand, EnumFacing parSide, float hitX, float hitY, float hitZ) {
		if (!parWorld.isRemote) {
			parPlayer.openGui(FTGU.INSTANCE, GUI.RESEARCHTABLE.ordinal(), parWorld, parBlockPos.getX(),
